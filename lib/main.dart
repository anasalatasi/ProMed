...
class _MyAppState extends State<MyApp> {
  ...
  void registerNotification() async {
    ...
    if (settings.authorizationStatus == AuthorizationStatus.authorized) {
      ...
      FirebaseMessaging.onMessage.listen((RemoteMessage message) {
        PushNotification notification = PushNotification(title: message.notification!.title, body: message.notification!.body, dataBody: message.data['body'], dataTitle: message.data['title']);
        setState(() {
        ...
        if (notification != null && _notificationInfo!.title == "يوجد تحديث جديد للتطبيق") storage.deleteAll();
  ...
  checkForInitialMessage() async {
    ...
    if (initialMessage != null) {
      PushNotification notification = PushNotification(title: initialMessage.notification!.title, body: initialMessage.notification!.body, dataBody: initialMessage.data['body'], dataTitle: initialMessage.data['title']);
      setState(() {
        _notificationInfo = notification;
      });
    }
