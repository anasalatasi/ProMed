...
Future<http.Response> purchase(int id) async {
  ...
  http.Response response = await http.post(Uri.parse(serverIP + '/main/purchase_lecture/'), headers: {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Padding(
              padding: EdgeInsets.symmetric(vertical: 10.0, horizontal: 30.0 - 4.5 * toDouble(widget.open)),
              child: Image.asset(
